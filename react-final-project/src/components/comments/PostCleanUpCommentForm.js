...
class PostCleanUpCommentForm extends Component {
    ...
    handleSubmit(event) {
        ...
        this.props.addPostCleanUpComment(this.state.cleanUpCommentContent, this.state.cleanUpId, this.state.cleanUpCommentUser);
    ...
    render () {
        return (
            <form className="cleanUpCommentForm" onSubmit={this.handleSubmit}>
                <label htmlFor="content__input"></label>
                    <input 
